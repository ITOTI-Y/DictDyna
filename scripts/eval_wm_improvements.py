...
def train_and_evaluate(
    ...
    test_s = torch.tensor(data["test"]["states"], dtype=torch.float32)
    test_a = torch.tensor(data["test"]["actions"], dtype=torch.float32)
    test_ns = torch.tensor(data["test"]["next_states"], dtype=torch.float32)
